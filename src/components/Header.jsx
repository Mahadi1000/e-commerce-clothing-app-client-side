          ...
          </div>
           {
            user? (
              ...
              >
                ...
                <li>
                  <button onClick={handleSignOut} className="text-accent-content">
                    Logout
                  </button>
                </li>
              </ul>
              ...
              <NavLink className="text-accent-content btn" to="/login">
                  Login
               </NavLink>
                  </li>
            )
